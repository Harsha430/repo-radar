...
It runs completely autonomously via GitHub Actions every day at 6:00 AM IST, aggregates data across 4 platforms, uses LLMs to conduct deep research, generates ready-to-record **Reel scripts** for social media, and delivers the final report directly to your Telegram.

---

## 🚀 How it Works

The pipeline is orchestrated as a state machine using **LangGraph** with 5 distinct agentic nodes:
